...
# Create Cartesian product of hyperparams, this is used for assignment 2.2
hyperparameter_combinations = list(itertools.product(embedding_dimensions, learning_rates))
...
def tune_hyperparams(dataset_first_rating_id, dataset_last_rating_id, epochs):
    ...
    embedding_dim = hyperparameters[0]["embedding_dim"]
